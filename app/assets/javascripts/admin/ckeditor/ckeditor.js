...
(function () {
    ...
    CKEDITOR.config.plugins = 'dialogui,dialog,about,a11yhelp,basicstyles,blockquote,clipboard,panel,floatpanel,menu,contextmenu,button,toolbar,elementspath,list,indent,enterkey,entities,floatingspace,listblock,richcombo,format,htmlwriter,horizontalrule,wysiwygarea,fakeobjects,link,magicline,pastetext,pastefromword,sourcearea,table,tabletools,undo';
    CKEDITOR.config.skin = 'moono';
    (function () {
        var icons = ( 'about,0,bold,32,italic,64,strike,96,subscript,128,superscript,160,underline,192,blockquote,224,copy-rtl,256,copy,288,cut-rtl,320,cut,352,paste-rtl,384,paste,416,bulletedlist-rtl,448,bulletedlist,480,numberedlist-rtl,512,numberedlist,544,indent-rtl,576,indent,608,outdent-rtl,640,outdent,672,horizontalrule,704,anchor-rtl,736,anchor,768,link,800,unlink,832,pastetext-rtl,864,pastetext,896,pastefromword-rtl,928,pastefromword,960,source-rtl,992,source,1024,table,1056,redo-rtl,1088,redo,1120,undo-rtl,1152,undo,1184' ), path = CKEDITOR.getUrl('plugins/icons.png'), icons = icons.split(',');
